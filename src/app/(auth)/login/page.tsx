      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold">EaseTinker</CardTitle>
            <CardDescription>
              Faça login para gerenciar seus projetos de fine-tuning de LLMs.
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 text-center text-sm text-muted-foreground">
              O cadastro é realizado automaticamente.
            </div>
          </CardContent>
        </Card>
      </div>
